...
export default function Hero() {
  ...
  return (
    <section className="relative hero-gradient min-h-[85vh] flex items-center overflow-hidden pt-[35px] md:pt-[35px]" ref={containerRef}>
      ...
      <div className="absolute bottom-0 left-0 right-0 overflow-hidden h-16 z-10 w-full">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="absolute bottom-0 w-[102%] h-16 text-[#F8F8F9] left-[-1%]">
          ...
          <path d="M0,0V15.81C13,36.92,27.64,56.86,47.69,72.05,99.41,111.27,165,111,224.58,91.58c31.15-10.15,60.09-26.07,89.67-39.8,40.92-19,84.73-46,130.83-49.67,36.26-2.85,70.9,9.42,98.6,31.56,31.77,25.39,62.32,62,103.63,73,40.44,10.79,81.35-6.69,119.13-24.28s75.16-39,116.92-43.05c59.73-5.85,118.5,22.88,168.6,62.28,44.93,35.35,83.4,84.46,122.37,125.38L1200,120V0Z" opacity=".5" className="fill-current"></path>
